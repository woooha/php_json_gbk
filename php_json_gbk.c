...
zend_module_entry php_json_gbk_module_entry = {
	...
	"php_json_gbk",
	php_json_gbk_functions,
	PHP_MINIT(php_json_gbk),
	PHP_MSHUTDOWN(php_json_gbk),
	PHP_RINIT(php_json_gbk),		/* Replace with NULL if there's nothing to do at request start */
	PHP_RSHUTDOWN(php_json_gbk),	/* Replace with NULL if there's nothing to do at request end */
	PHP_MINFO(php_json_gbk),
#if ZEND_MODULE_API_NO >= 20010901
